...
namespace jwt_lms.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public async Task<IActionResult> FetchCourseID()
        {
            ...
            // Lấy token từ header "Authorization" hoặc từ cookie "token"
            string token = null;
            ...
            // Nếu không có token trong header, lấy từ cookie "token"
            if (string.IsNullOrEmpty(token) && Request.Cookies.ContainsKey("token"))
            {
